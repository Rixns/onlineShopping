              ...
              <ul class="sui-nav">
                <li :class="{ active: isOne}" @click="changeOrder('1')">
                  <a>综合<span v-show="isOne" class="iconfont"
				   :class="{'icon-arrow-up-filling':isAsc,'icon-arrow-down-filling':isDesc}"></span></a>
                </li>
...
<script>
  ...
  export default {
	...
	// 当组件挂载完毕之前执行一次
	beforeMount() {
		// 在发请求之前 把接口需要的参数进行整理 服务器就会返回查询的数据
	...
	methods:{
		...
		removeCategoryName(){
			...
			// 地址栏也需要修改：路由跳转
			// 本意是删除query，如果路径当中出现params不应该删除，路由跳转的时候应该带上s
